...
public final class LogRewritePolicy implements RewritePolicy {
    ...
    public LogEvent rewrite(final LogEvent event) {
        try {
            ...
            formattedMessage = formattedMessage.replaceAll("(series=)(\\d{2})(\\d{2})", PASSPORT_SERIES_REPLACEMENT);
            formattedMessage = formattedMessage.replaceAll("(passportNumber=)(\\d{3})(\\d{3})", PASSPORT_REPLACEMENT);
            formattedMessage = formattedMessage.replaceAll("(number=)(\\d{3})(\\d{3})", PASSPORT_REPLACEMENT);
            ...
            formattedMessage = formattedMessage.replaceAll("(\"series\"\\s*:\\s*\")(\\d{2})(\\d{2}\")", PASSPORT_SERIES_REPLACEMENT);
            formattedMessage = formattedMessage.replaceAll("(\"passportNumber\"\\s*:\\s*\")(\\d{3})(\\d{3}\")", PASSPORT_REPLACEMENT);
            formattedMessage = formattedMessage.replaceAll("(\"number\"\\s*:\\s*\")(\\d{3})(\\d{3}\")", PASSPORT_REPLACEMENT);
